...
<body>
    <header style="position: fixed; top: 0; left: 0; right: 0; z-index: 1000; background-color: #072A6C; color: white; padding: 1rem 2rem; display: flex; align-items: center; justify-content: space-between; font-family: 'Nunito', sans-serif;">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h1 style="margin: 0; font-size: 1.8rem; font-weight: 700;">College Voting System</h1>
        </div>

        <!-- Right Section: Username and Profile Image -->
        <div style="display: flex; align-items: center;">
            <span style="font-weight: 600; margin-right: 10px;">{{ Auth::user()->name ?? 'User' }}</span>
            <img src="{{ Auth::user()->profile_image_url ?? asset('images/profile.png') }}"
                 alt="Profile Image" style="height: 50px; width: 50px; border-radius: 50%; object-fit: cover;">
        </div>
    </header>
